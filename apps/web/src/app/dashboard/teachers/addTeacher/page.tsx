  ...
  return (
    <div className="flex-1">
      <div className="flex h-16 justify-center items-center mb-8">
        <h1 className="text-3xl font-bold text-primary">Adicionar Professor</h1>
      </div>
          ...
          <TabsContent value="basic">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Edite as informações pessoais do professor.</CardDescription>
              </CardHeader>
          ...
          <TabsContent value="categories">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Selecione as categorias aplicáveis.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox id="outras" />
                    <Label htmlFor="outras">Outras Comunidades Tradicionais</Label>
                  </div>
                </div>
              </CardContent>
              <CardFooter>
